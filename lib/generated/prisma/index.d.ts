...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "password" | "userType" | "phoneNumber" | "dateOfBirth" | "familyCode" | "parentEmail" | "parentPhone" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type FamilyOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"code" | "createdAt" | "updatedAt", ExtArgs["result"]["family"]>
  ...
  export interface FamilyDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const familyWithCodeOnly = await prisma.family.findMany({ select: { code: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Families and only return the `code`
     * const familyWithCodeOnly = await prisma.family.createManyAndReturn({
     *   select: { code: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Families and only return the `code`
     * const familyWithCodeOnly = await prisma.family.updateManyAndReturn({
     *   select: { code: true },
     *   where: {
     *     // ... provide filter here
     *   },
